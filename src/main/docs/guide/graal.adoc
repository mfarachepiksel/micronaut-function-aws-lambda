...
=== 4. Build the Graal Native Image using Docker

To create the Graal native image we use Docker. Run:

[source,bash]
.Building Graal native image
----
$ docker build . -t vies-vat-validator
----

=== 5. Run the Native Function

The native function is now built. You can run it:
